              ...
              (lamS
               ...
               (lamS
                ...
                (ifS
                 ...
                 (appS
                  (plusS)
                  (list (numS 1) (appS (idS 'divinter) (list (idS 'm) (idS 'n) (idS 'n)))))
                 (ifS
...
(define (div-inter-second)
  (numS 0))

(define (div-inter-third)
  (letrecS
   'm
   (idS 'n)
   (idS 'k)))
